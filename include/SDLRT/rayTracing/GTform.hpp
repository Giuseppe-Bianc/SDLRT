...
namespace qbRT {
    ...
    public:
        ...
        GTform(const glm::dvec3 &translation, const glm::dvec3 &rotation, const glm::dvec3 &scale) noexcept {
        ...
        Ray Apply(const Ray &inputRay, bool dirFlag) const noexcept;
        glm::dvec3 Apply(const glm::dvec3 &inputVector, bool dirFlag) const noexcept;
